...
public class AccountController {
    ...
    public ResponseEntity<PageResult<AccountDTO>> sitePageQuery(
    ...
    public ResponseEntity<AccountDTO> findById(
        ...
        AccountDTO account = accountService.findById(id, siteType);
    ...
    public ResponseEntity<Void> saveRole(
            @RequestParam(value = "accountId") Integer accountId, @RequestParam(value = "roleId") Integer roleId) {
    ...
    public ResponseEntity<Void> saveSite(
            @RequestParam(value = "accountId") Integer accountId, @RequestParam(value = "siteId") Integer siteId) {
    ...
    public ResponseEntity<Void> updateCenterSite(
            @RequestParam(value = "accountId") Integer accountId, @RequestParam(value = "siteId") Integer siteId) {
