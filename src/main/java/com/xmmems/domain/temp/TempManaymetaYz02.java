...
public class TempManaymetaYz02 {
    private Integer id;

    private String yz_cate;

    private String anlyDate;
    ...
    public String getYz_cate() {
        return yz_cate;
    }

    public void setYz_cate(String yz_cate) {
        this.yz_cate = yz_cate == null ? null : yz_cate.trim();
    }

    public String getAnlyDate() {
        return anlyDate;
    }

    public void setAnlyDate(String anlyDate) {
        this.anlyDate = anlyDate == null ? null : anlyDate.trim();
    }
